...
public class PriceRepositoryTest {
    ...
    public void randomTest() throws Exception {
        ...
        mockServer.reset();
        mockServer.expect(ExpectedCount.once(), requestTo("https://api.lyft.com/v1/cost?start_lat=37.7763&start_lng=-122.3918&end_lat=37.7972&end_lng=-122.4533"))
                .andExpect(method(HttpMethod.GET))
                .andExpect(header("Accept", MediaType.APPLICATION_JSON_VALUE))
                .andRespond(withSuccess("{fsfsf}", MediaType.APPLICATION_JSON));


        priceRepository.requestPrice(new Position(37.7763, -122.3918, 37.7972, -122.4533));
